    ...
    <tr class="containerkiri">
      ...
      <!-- <div class="containerkiri"> -->
        <div class="card-body">
          ...
          <a href="../transaction/cart.php?id_bar=9"></a>
        </div>
      </div>
    </tr>
    ...
    <tr class="containerkanan">
      ...
      <!-- <div class="containerkiri"> -->
        <div class="card-body">
          ...
          <a href="../transaction/cart.php??id_bar=10"></a>
        </div>
      </div>
    </tr>
    ...
    <tr class="containerbawah">
      ...
      <!-- <div class="containerkiri"> -->
        <div class="card-body">
          ...
          <a href="../transaction/cart.php??id_bar=11"></a>
        </div>
      </div>
    </tr>
    ...
    <tr class="containerbawah">
      ...
      <!-- <div class="containerkiri"> -->
        <div class="card-body">
          ...
          <a href="../transaction/cart.php?id_bar=12"></a>
        </div>
      </div>
    </tr>
    ...
    <tr class="containerbawah">
      ...
      <!-- <div class="containerkiri"> -->
        <div class="card-body">
          ...
          <a href="../transaction/cart.php?id_bar=13"></a>
        </div>
      </div>
    </tr>
  </div>
