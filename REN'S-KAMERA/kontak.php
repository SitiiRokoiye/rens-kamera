...
<section class="nabar">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
        <a class="navbar-brand" href="#">RENT'S KAMERA</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="kontak.php">About Us</a>
                    </li>
                </ul>
...
echo "<h1>$judul</h1>";
	echo"<br>";
?>
	 <h3><img src="img/gif3.gif" alt="menukamera" style="width : 800px;margin-left: 30px;" ></h3> 
